...
public:
	...
	struct sSaveAttribs {
		...
		sSaveAttribs(){
			...
			this->IncludeUV = true;
			this->IncludeRGB = true;
			this->IncludeAlpha = true;
			this->IncludeTangent = true;
			this->IncludeBiNormal = true;
		};
		bool IncludeNormals;
		bool IncludeUV;
		bool IncludeRGB;
		bool IncludeAlpha;
		bool IncludeTangent;
		bool IncludeBiNormal;
	};

	bool SavePlyFileASCII( std::wstring fileName, bool bOverwrite, 
						   bool IncludeNormals, bool IncludeUV,
						   bool IncludeRGB, bool IncludeAlpha, 
						   bool IncludeTangent, bool IncludeBiNormal );
	bool SavePlyFileASCII(std::wstring fileName, bool bOverwrite, const sSaveAttribs &saveAttributes );
